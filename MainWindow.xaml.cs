...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    using Network.BodySender;    /// <summary>
    ...
    public partial class MainWindow : Window
    {
        ...
        private void SensorSkeletonFrameReady(object sender, SkeletonFrameReadyEventArgs e)
        {
            ...
            SkeletonFilter filter = new SkeletonFilter(this.sensor);
            ...
            using (DrawingContext dc = this.drawingGroup.Open())
            {
                ...
                if (skeletons.Length != 0)
                {
                    ...
                    {
                        filteredSkeleton = filter.Filter(skel);
                        RenderClippedEdges(filteredSkeleton, dc);
                       
                        if (filteredSkeleton.TrackingState == SkeletonTrackingState.Tracked)
                        {
                            this.DrawBonesAndJoints(filteredSkeleton, dc);
                        }
                        else if (filteredSkeleton.TrackingState == SkeletonTrackingState.PositionOnly)
                        {
                            dc.DrawEllipse(
                        ...
                        this.bodySender.SendSkeleton(filteredSkeleton);
                    }
                }
