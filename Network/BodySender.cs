...
namespace Microsoft.Samples.Kinect.SkeletonBasics.Network.BodySender
{
    public class BodySender
    {
        ...
        public void SendSkeleton(Skeleton body)
        {
            if (body.TrackingState == Microsoft.Kinect.SkeletonTrackingState.Tracked)
            {
                this.Send(body);
            }
        ...
        public void Send(Skeleton[] bodies)
        {
        ...
        private void Send(Skeleton body)
        {
            foreach (Microsoft.Kinect.Joint joint in body.Joints)
            {
