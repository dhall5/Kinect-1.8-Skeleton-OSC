...
namespace Microsoft.Samples.Kinect.Avateering
{
    ...
    public static class KinectHelper
    {
        ...
        public static System.Numerics.Vector4 DistanceToLineSegment(Vector3 linePoint0, Vector3 linePoint1, Vector3 point)
        {
            ...
            return new System.Numerics.Vector4(normal, distance);
        }
